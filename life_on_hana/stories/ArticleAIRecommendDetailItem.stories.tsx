...
const meta: Meta<typeof ArticleAIRecommendDetailItem> = {
  ...
  argTypes: {
    ...
    content: { control: "text", description: "내용" },
    url: { control: "text", description: "URL" },
  },
};
...
export const Default: Story = {
  args: {
    title: "[서울 출발] 울산 2박 3일 여행 패키지",
    content: `귀하의 소비 패턴을 고려하여 울산 현대호텔 숙박을 추천드립니다. 또한, 고객님의 미술관 방문 기록을 바탕으로 울산 박물관 관람을 일정에 포함되어 있습니다. 
...
export const Long: Story = {
  args: {
    title: "긴 글 스크롤 테스트",
    content: `귀하의 소비 패턴을 고려하여 울산 현대호텔 숙박을 추천드립니다. 
