  ...
  return (
    <div className="w-[24.5625rem] flex flex-col justify-between relative p-2 border-b">
      ...
      <div className="flex justify-between">
        <div className="text-[.625rem] text-black font-SCDream3 mt-1 ml-7">{"출금 가능"}</div>
        <div className="text-[.625rem] text-black font-SCDream8 mt-1">{balance.toLocaleString()} 원</div>
      </div>
      {isAccountChecked && (
        <div className="mt-4">
          <div className="text-[.875rem] text-black font-SCDream3">{"출금금액"}</div>
          <div className="flex items-center justify-start">
            ...
            />
            <div className="ml-2 text-black text-[.875rem] font-SCDream3 mt-2">원</div>
          </div>
        </div>
      )}
