...
export default function Columns() {
    ...
    const [likedArticles, setLikeArticles] = useState<TArticlesLiked[]>(mockArticles);
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ...
        <div className="p-6 space-y-4 mb-16">
            ...
            <div className="w-full h-full flex flex-col items-center gap-4">
                {likedArticles.length > 0 ? (
                    <>
                        <ArticleList articles={likedArticles.slice(startIdx, startIdx + 5)} />
                        <WhilickCarousel items={likedArticles.slice(startIdx, startIdx + 10)} />
                        <ArticleList articles={likedArticles.slice(startIdx + 5, startIdx + 10)} />
                    </>
                ) : (
