...
const mockData = {
  ...
  content: [
    ...
    },
    {
      type: "TEXT",
      content:
        "“간절욱조조반도(艮絶旭肇早半島)-간절곶에 해가 떠야 한반도에 새벽이 온다”. 울주 간절곶 표지석에는 이런 문장이 적혀있다. 1902년 군수 김우식이 <울산읍지>>에 이렇게 썼다. 간절곶은 우리나라 육지에서 가장 먼저 해가 떠오르",
    },
  ],
      ...
      <div className="w-full flex flex-col">
        <div className="w-full h-[calc(100vh-208px)] overflow-y-auto">
          ...
          <div className=" w-[90%] flex flex-col mx-auto">
            <div className="font-SCDream5 text-[15px]">
