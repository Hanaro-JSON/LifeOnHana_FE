...
const mockData = {
  ...
  content: [
    ...
    {
      type: "IMAGE",
      content: "https://hana1qm.com/dataFile/bbs/202432011132520529.jpg",
      caption: "이미지 설명"
    },
    {
      type: "TEXT",
    ...
    {
      type: "TEXT",
      content: "“간절욱조조반도(艮絶旭肇早半島)-간절곶에 해가 떠야 한반도에 새벽이 온다”. 울주 간절곶 표지석에는 이런 문장이 적혀있다. 1902년 군수 김우식이 <울산읍지>>에 이렇게 썼다. 간절곶은 우리나라 육지에서 가장 먼저 해가 떠오르"
    }
  ],
      ...
      <div className="w-full flex flex-col">
        <div className="w-full h-[calc(100vh-208px)] overflow-y-auto">
          ...
          <div className="relative w-full h-[150px]">
            ...
            />
            <div className="absolute w-full h-full flex flex-col justify-center items-start ml-8">
              <div className="font-SCDream8 text-[22.4px] text-hanapurple font-bold">
                {article.category}
              </div>
              <div className="font-SCDream8 text-[25px] text-white font-bold">
                {titleParts[0]}
                {titleParts[1] && <br />}
                {titleParts[1]}
              </div>
          ...
          <div className=" w-[90%] flex flex-col mx-auto">
            <div className="font-SCDream5 text-[15px]">{article.published_at}</div>
  ...
  {article.content.map((item, index) => {
    if (item.type === "IMAGE") {
      ...
      return (
        <span
          key={index}
          className="underline decoration-1 decoration-hanapurple font-SCDream3 text-[16px] leading-relaxed"
        >
          {item.content}
        </span>
      );
      ...
      return null; // 그 외 type은 처리 없음
            ...
            <div className="w-[100%] mx-auto border-b-2 border-b-hanadeepgray"></div>
            ...
            <div className="font-SCDream5 text-[15px] my-3">XXX님의 AI 맞춤 정보</div>
